...
import { classify, todayISO, type Milestone, type MilestonesData } from "@/lib/milestones";
  ...
  const content = (
    <div className="max-w-5xl mx-auto py-12 px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="mb-8">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-white">Milestone Details</h1>
        <p className="text-slate-600 dark:text-gray-300 mt-2">
          Full milestone history per student, including review comments.
          {data?.last_updated && (
